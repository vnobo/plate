    ...
    <nz-modal [(nzVisible)]="isVisible" nzTitle="菜单编辑" (nzOnCancel)="handleCancel()" (nzOnOk)="handleOk()">
      <form nz-form (ngSubmit)="onSubmit()">
        <ng-container *nzModalContent class="p-3">
          <div class="row g-3 ">
            <nz-form-item class="col-md">
              ...
              <nz-form-control [nzSpan]="18" nzHasFeedback nzValidatingTip="验证中..." [nzErrorTip]="codeErrorTpl">
                <input nz-input type="text" id="code" formControlName="code" [disabled]="true" />
            ...
            <nz-form-item class="col-md">
              ...
              <nz-form-control [nzSpan]="18" nzHasFeedback nzValidatingTip="验证中..." [nzErrorTip]="pcodeErrorTpl">
                <input [disabled]="true" nz-input type="text" id="pcode" formControlName="pcode" />
          ...
          <div class="row g-3">
            <nz-form-item class="col-md">
              <nz-form-label [nzSpan]="6" nzRequired nzFor="code" for="tenantCode">租户 </nz-form-label>
              <nz-form-control
                [nzSpan]="18"
                nzHasFeedback
                nzValidatingTip="验证中..."
                [nzErrorTip]="tenantCodeErrorTpl">
                <input type="text" class="form-control" id="tenantCode" formControlName="tenantCode" />
            ...
            <nz-form-item class="col-md">
              <nz-form-label [nzSpan]="6" nzRequired nzFor="code" for="type">类型 </nz-form-label>
              <nz-form-control [nzSpan]="18" nzHasFeedback nzValidatingTip="验证中..." [nzErrorTip]="typeErrorTpl">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="extend" formControlName="extend" />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="icons" formControlName="icons" />
          </div>
        </ng-container>
