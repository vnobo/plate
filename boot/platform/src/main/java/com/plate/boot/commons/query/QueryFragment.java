...
public final class QueryFragment extends HashMap<String, Object> {
    ...
    /**
     * Represents a condition in the QueryFragment.
     *
     * <p>This class represents a condition in the QueryFragment, which can be used to construct
     * a SQL query. It contains a Criteria object and a prefix identifier.
     *
     * <p>Example usage:
     * <pre>
     * {@code
     * QueryFragment queryFragment = QueryFragment.from("users");
     * queryFragment.condition(Condition.of(Criteria.where("name").is("John")));
     * }
     * </pre>
     */
    @Getter
    public static class Condition extends HashMap<String, Object> {
        ...
        /**
         * Creates Condition instance based on the specified Criteria object
         *
         * <p>Example usage for basic condition:
         * <pre>{@code
         * Condition condition = Condition.of(Criteria.where("name").is("John"));
         * QueryFragment fragment = QueryFragment.from("users").condition(condition);
         * }</pre>
         * This generates SQL: "SELECT ... FROM users WHERE name = 'John'"
         *
        ...
        /**
         * Creates a Condition instance with prefix identifier based on specified Criteria
         *
         * <p>Example usage with table prefix:
         * <pre>{@code
         * Condition condition = Condition.of(Criteria.where("age").greaterThan(30), "user");
         * QueryFragment fragment = QueryFragment.from("users").condition(condition);
         * }</pre>
         * This generates SQL: "SELECT ... FROM users WHERE user.age > 30"
         *
         * <p>Example usage with column prefix:
         * <pre>{@code
         * Condition condition = Condition.of(Criteria.where("status").is("active"), "employee");
         * QueryFragment fragment = QueryFragment.from("staff").condition(condition);
         * }</pre>
