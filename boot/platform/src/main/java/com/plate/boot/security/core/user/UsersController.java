...
public class UsersController {
     ...
     *
     * @param request  A UserRequest object encapsulating the search criteria. It also supports
     ...
     * @return A Flux of UserResponse objects representing the found users matching the
    ...
    /**
     * Modifies an existing user based on the provided {@link UserRequest}.
     ...
     * Upon successful update, maps the modified {@link User} to a {@link UserResponse} for the API response.
     *
     * @param request A validated {@link UserRequest} containing the details for the user modification,
     *                with a non-null ID of the user to be modified.
     * @return A {@link Mono} emitting the updated user information as a {@link UserResponse}.
