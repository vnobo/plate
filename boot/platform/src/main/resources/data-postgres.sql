insert into se_users(code, tenant_code, username, password, name, creator, updater)
values ('U1000', 'T1000', 'admin',
...
insert into se_groups(code, tenant_code, name, creator, updater)
values ('G1000', 'T1000', '默认组', 'U1000', 'U1000');
